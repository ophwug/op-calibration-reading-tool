...
app.innerHTML = `
  <section class="tool-shell">
    ...
    <section class="related-tool" id="remounting-help">
      ...
      <p>To reuse the existing mount instead, also remove its old adhesive, clean it with alcohol pads, and let it dry. Then cut a <a href="${REPLACEMENT_MOUNT_ADHESIVE_URL}" target="_blank" rel="noreferrer">fresh sheet of VHB adhesive</a> to fit and apply it to the mount.</p>
